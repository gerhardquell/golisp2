...
| `doc/primitiven.md` | Referenzliste aller Primitiven | *nie* — Wahrheit ist `primitives.go` |
...
**Modelle/Shortcodes für `sigo`:** nicht in der Doku nachschlagen —
`(sigo-models)` ist die einzige Wahrheit. Provider deployen laufend neu.
